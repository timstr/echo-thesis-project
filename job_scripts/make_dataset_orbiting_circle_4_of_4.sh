...
#PBS -N make_dataset_orbiting_circle_4_of_4
#PBS -A st-rhodin-1-gpu
#PBS -m abe
#PBS -M timstr@cs.ubc.ca
#PBS -o /scratch/st-rhodin-1/users/timstr/echo/logs/make_dataset_orbiting_circle_4_of_4_OUTPUT.txt
#PBS -e /scratch/st-rhodin-1/users/timstr/echo/logs/make_dataset_orbiting_circle_4_of_4_ERROR.txt
