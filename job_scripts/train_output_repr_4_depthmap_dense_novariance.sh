...
#PBS -N train_output_repr_4_depthmap_dense_novariance
#PBS -A st-rhodin-1-gpu
#PBS -m abe
#PBS -M timstr@cs.ubc.ca
#PBS -o /scratch/st-rhodin-1/users/timstr/echo/logs/train_output_repr_4_depthmap_dense_novariance_OUTPUT.txt
#PBS -e /scratch/st-rhodin-1/users/timstr/echo/logs/train_output_repr_4_depthmap_dense_novariance_ERROR.txt
...
python3 echolearn.py \
    --experiment=train_output_repr_4_depthmap_dense_novariance \
    --batchsize=64 \
    --receivercount=8 \
