...
#PBS -N train_input_repr_audioraw_without_summary_stats
#PBS -A st-rhodin-1-gpu
#PBS -m abe
#PBS -M timstr@cs.ubc.ca
#PBS -o /scratch/st-rhodin-1/users/timstr/echo/logs/train_input_repr_audioraw_without_summary_stats_OUTPUT.txt
#PBS -e /scratch/st-rhodin-1/users/timstr/echo/logs/train_input_repr_audioraw_without_summary_stats_ERROR.txt
...
python3 echolearn.py \
    --experiment=train_input_repr_audioraw_without_summary_stats \
    --batchsize=64 \
    --receivercount=8 \
