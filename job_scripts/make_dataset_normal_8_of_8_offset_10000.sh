...
#PBS -N make_dataset_normal_8_of_8_offset_10000
#PBS -A st-rhodin-1-gpu
#PBS -m abe
#PBS -M timstr@cs.ubc.ca
#PBS -o /scratch/st-rhodin-1/users/timstr/echo/logs/make_dataset_normal_8_of_8_offset_10000_OUTPUT.txt
#PBS -e /scratch/st-rhodin-1/users/timstr/echo/logs/make_dataset_normal_8_of_8_offset_10000_ERROR.txt
